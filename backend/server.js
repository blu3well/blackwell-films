...
const dns = require("node:dns"); // NEW: Import DNS module
require("dotenv").config();

// --- CRITICAL FIX: FORCE IPv4 ---
// This stops Render from trying to use IPv6, which causes the ETIMEDOUT error
try {
...
// --- EMAIL CONFIGURATION ---
// Using explicit settings with the DNS fix above
let transporter;
try {
  transporter = nodemailer.createTransport({
    ...
    tls: {
      rejectUnauthorized: false, // Helps prevents SSL handshake hangs
    },
  });
